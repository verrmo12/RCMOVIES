        ...
        >
          ...
          {heading !== "Casts" && (
            <div className="flex gap-1 mb-2">
              <button
                onClick={card.handleClick}
                className="py-1 px-3  text-gray-200 rounded-sm font-semibold flex  items-center gap-2 hover:text-black hover:bg-gray-200 hover:scale-105 transition-all duration-500 easeInOut"
              >
                <Link
                  href={
