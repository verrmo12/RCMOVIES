  ...
  return (
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <a href="#" className="flex items-center mb-4 sm:mb-0">
            ...
            <span className={`self-center text-2xl text-gray-200 font-black whitespace-nowrap `}>RC MOVIES</span>
        </a>
    ...
    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">RCMOVIES</a>. All Rights Reserved.
